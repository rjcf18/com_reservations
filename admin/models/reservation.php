...
/**
 * Reservation Model for the Reservations component
 *
 * @since 1.0
 */
class ReservationsModelReservation extends JModelAdmin
{
    /**
    ...
    */
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState(
            'com_reservations.edit.reservation.data',
            array()
        );
