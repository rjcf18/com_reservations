                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th style="width:10%" class="nowrap hidden-sm-down text-center">
		                        <?php echo JHtml::_('searchtools.sort',  'COM_RESERVATIONS_FIELD_USERNAME_LABEL', 'user_id', $listDirn, $listOrder); ?>
                            </th>
                            <th style="width:10%" class="nowrap hidden-sm-down text-center">
                        ...
                        <?php foreach ($this->items as $i => $row) :
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
										<?php echo JHtml::_('jgrid.published', $row->published, $i, 'reservations.', true, 'cb'); ?>
                                    </div>
                                </td>
                                <td class="small hidden-sm-down">
                                    <a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_RESERVATIONS_EDIT_RESERVATIONS'); ?>">
										<?php echo $this->escape($row->space); ?>
                                    </a>
                                </td>
                                ...
                                <td class="small hidden-sm-down text-center">
									<?php echo $this->escape($row->end); ?>
                                </td>
                                <td class="hidden-sm-down text-center">
									<?php echo $this->escape((int) $row->id); ?>
                                </td>
                            </tr>
						<?php endforeach; ?>
                        </tbody>
